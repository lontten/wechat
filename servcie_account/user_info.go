...
func (c ServiceAccountConfig) GetFans(nextOpenid ...string) (GetFansResp, error) {
...
// total 为服务号关注者总数（接口返回的 total）
// https://developers.weixin.qq.com/doc/service/api/usermanage/userinfo/api_getfans.html
func (c ServiceAccountConfig) GetAllFans(handler func(openids []string, total int) error) error {
...
// total 为服务号关注者总数（接口返回的 total）
// https://developers.weixin.qq.com/doc/service/api/usermanage/userinfo/api_getfans.html
func (c ServiceAccountConfig) GetAllFansEach(handler func(openid string, total int) error) error {
...
func (c ServiceAccountConfig) UserInfo(openid string, lang ...string) (UserInfoResp, error) {
...
func (c ServiceAccountConfig) BatchUserinfo(userList []BatchUserinfoItem) (BatchUserinfoResp, error) {
